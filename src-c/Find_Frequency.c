...
int main(int argc, char **argv)
{
    ...
    for (i=0;i<number_of_files;i++){
        ...
        printf("Balayage de 100us a 200us, pas de 10us\n");
        Larmor_frequency_Hertz = Larmor_frequency_Hertz + step_frequency_Hertz*i;
        excitation_burst_cycles_tot = Larmor_frequency_Hertz *excitation_duration_seconds;
        printf("frequence de larmor %f\n",Larmor_frequency_Hertz);
        ...
        oscillator_frequency = Larmor_frequency_Hertz + 1000;
        if(rp_GenFreq(RP_CH_2, oscillator_frequency) != RP_OK){
            fprintf(stderr, "rp_GenFreq RP_CH_1 failed!\n");
        return -1;
        }
