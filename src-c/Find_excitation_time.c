...
int main(int argc, char **argv)
{
    ...
    float Start_excitation_duration_seconds;
    ...
    Start_excitation_duration_seconds = atof(argv[6]);
    float step_excitation_duration_seconds = atof(argv[7]);
    int wait = atoi(argv[8]);
    
    printf("larmor %f, duration excitation %f\n",Larmor_frequency_Hertz, Start_excitation_duration_seconds);

    int excitation_burst_cycles_tot = Larmor_frequency_Hertz *Start_excitation_duration_seconds;
    ...
    float excitation_duration_seconds = Start_excitation_duration_seconds;
    ...
    for (i=0;i<number_of_files;i++){
        ...
        /////// CHANGEMENT DU TEMPS DEXCITATION //////
        
        excitation_duration_seconds = excitation_duration_seconds + step_excitation_duration_seconds*i;
        excitation_burst_cycles_tot = Larmor_frequency_Hertz *excitation_duration_seconds;
        printf("temps d'excitation %f\n",excitation_duration_seconds);
        printf("nombre des periodes dans le burst %d\n",excitation_burst_cycles_tot);
        if(rp_GenBurstCount(RP_CH_1, excitation_burst_cycles_tot) != RP_OK){
            fprintf(stderr, "rp_GenBurstCount RP_CH_1 failed!\n");
            return -1;
        }//valeur max pour GenBurstCount = 50 000
